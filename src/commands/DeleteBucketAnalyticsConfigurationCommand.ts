...
import { DeleteBucketAnalyticsConfigurationCommand as __AWS__DeleteBucketAnalyticsConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__DeleteBucketAnalyticsConfigurationCommand(this.input));
    }
