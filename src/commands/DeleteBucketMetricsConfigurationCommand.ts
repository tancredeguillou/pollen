...
import { DeleteBucketMetricsConfigurationCommand as __AWS__DeleteBucketMetricsConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__DeleteBucketMetricsConfigurationCommand(this.input));
    }
