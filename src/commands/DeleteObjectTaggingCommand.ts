...
import { DeleteObjectTaggingCommand as __AWS__DeleteObjectTaggingCommand } from "@aws-sdk/client-s3";

import { DeleteObjectTaggingRequest, DeleteObjectTaggingOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__DeleteObjectTaggingCommand(this.input));
    }
