...
import { GetBucketAnalyticsConfigurationCommand as __AWS__GetBucketAnalyticsConfigurationCommand } from "@aws-sdk/client-s3";

import { GetBucketAnalyticsConfigurationRequest, GetBucketAnalyticsConfigurationOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketAnalyticsConfigurationCommand(this.input));
    }
