...
import { GetBucketIntelligentTieringConfigurationCommand as __AWS__GetBucketIntelligentTieringConfigurationCommand } from "@aws-sdk/client-s3";

import { GetBucketIntelligentTieringConfigurationRequest, GetBucketIntelligentTieringConfigurationOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketIntelligentTieringConfigurationCommand(this.input));
    }
