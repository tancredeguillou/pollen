...
import { GetBucketInventoryConfigurationCommand as __AWS__GetBucketInventoryConfigurationCommand } from "@aws-sdk/client-s3";

import { GetBucketInventoryConfigurationRequest, GetBucketInventoryConfigurationOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketInventoryConfigurationCommand(this.input));
    }
