...
import { GetBucketLocationCommand as __AWS__GetBucketLocationCommand } from "@aws-sdk/client-s3";

import { GetBucketLocationRequest, GetBucketLocationOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketLocationCommand(this.input));
    }
