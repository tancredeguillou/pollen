...
import { GetBucketPolicyCommand as __AWS__GetBucketPolicyCommand } from "@aws-sdk/client-s3";

import { GetBucketPolicyRequest, GetBucketPolicyOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketPolicyCommand(this.input));
    }
