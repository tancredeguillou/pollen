...
import { GetBucketReplicationCommand as __AWS__GetBucketReplicationCommand } from "@aws-sdk/client-s3";

import { GetBucketReplicationRequest, GetBucketReplicationOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketReplicationCommand(this.input));
    }
