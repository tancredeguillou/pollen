...
import { GetBucketTaggingCommand as __AWS__GetBucketTaggingCommand } from "@aws-sdk/client-s3";

import { GetBucketTaggingRequest, GetBucketTaggingOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetBucketTaggingCommand(this.input));
    }
