...
import { GetObjectAclCommand as __AWS__GetObjectAclCommand } from "@aws-sdk/client-s3";

import { GetObjectAclRequest, GetObjectAclOutput } from "../models/models_0";
...
export class GetObjectAclCommand extends Command<
    ...
    ServiceOutputTypes
> {
    public input: GetObjectAclCommandInput;
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetObjectAclCommand(this.input));
    }
}