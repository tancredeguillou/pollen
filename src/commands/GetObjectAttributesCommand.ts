...
import { GetObjectAttributesCommand as __AWS__GetObjectAttributesCommand } from "@aws-sdk/client-s3";

import { GetObjectAttributesRequest, GetObjectAttributesOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetObjectAttributesCommand(this.input));
    }
}