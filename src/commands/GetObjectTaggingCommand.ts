...
import { GetObjectTaggingCommand as __AWS__GetObjectTaggingCommand } from "@aws-sdk/client-s3";

import { GetObjectTaggingRequest, GetObjectTaggingOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetObjectTaggingCommand(this.input));
    }
