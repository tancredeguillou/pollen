...
import { GetPublicAccessBlockCommand as __AWS__GetPublicAccessBlockCommand } from "@aws-sdk/client-s3";

import { GetPublicAccessBlockRequest, GetPublicAccessBlockOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__GetPublicAccessBlockCommand(this.input));
    }
