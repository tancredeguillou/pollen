...
import { HeadObjectCommand as __AWS__HeadObjectCommand } from "@aws-sdk/client-s3";

import { HeadObjectRequest, HeadObjectOutput } from "../models/models_0";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__HeadObjectCommand(this.input));
    }
