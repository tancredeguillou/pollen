...
import { PutBucketAnalyticsConfigurationCommand as __AWS__PutBucketAnalyticsConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutBucketAnalyticsConfigurationCommand(this.input));
    }
