...
import { PutBucketInventoryConfigurationCommand as __AWS__PutBucketInventoryConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutBucketInventoryConfigurationCommand(this.input));
    }
