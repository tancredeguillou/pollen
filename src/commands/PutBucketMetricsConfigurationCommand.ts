...
import { PutBucketMetricsConfigurationCommand as __AWS__PutBucketMetricsConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutBucketMetricsConfigurationCommand(this.input));
    }
