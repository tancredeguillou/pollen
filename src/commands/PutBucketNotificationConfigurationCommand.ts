...
import { PutBucketNotificationConfigurationCommand as __AWS__PutBucketNotificationConfigurationCommand } from "@aws-sdk/client-s3";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutBucketNotificationConfigurationCommand(this.input));
    }
