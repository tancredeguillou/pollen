...
import { PutObjectAclCommand as __AWS__PutObjectAclCommand } from "@aws-sdk/client-s3";

import { PutObjectAclRequest, PutObjectAclOutput } from "../models/models_1";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutObjectAclCommand(this.input));
    }
