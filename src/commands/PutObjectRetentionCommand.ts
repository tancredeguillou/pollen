...
import { PutObjectRetentionCommand as __AWS__PutObjectRetentionCommand } from "@aws-sdk/client-s3";

import { PutObjectRetentionRequest, PutObjectRetentionOutput } from "../models/models_1";
...
> {
    ...
    async resolve(providers: Providers): Promise<void> {
        await providers.getAwsProvider().client.send(new __AWS__PutObjectRetentionCommand(this.input));
    }
